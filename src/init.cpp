...
void SetupServerArgs(ArgsManager& argsman, bool can_listen_ipc)
{
    ...
    argsman.AddArg("-coinsnegcachesize=<n>", strprintf("Cache up to <n> MiB of recently-seen missing chainstate coins so repeated lookups for the same absent outpoint (e.g. orphan-parent floods) skip the database (0 to disable, default: %d)", nDefaultCoinsNegCacheSizeMiB), ArgsManager::ALLOW_ANY, OptionsCategory::OPTIONS);
