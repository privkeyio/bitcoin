...
void SetupChainParamsBaseOptions(ArgsManager& argsman)
{
    ...
    argsman.AddArg("-powchangetime=time[:algo]", "Schedule a proof-of-work algorithm change at the given block time, selecting algo (0=SHA256, 1=SHA256d, 2=RIPEMD160, 3=HASH160, 4=rotate hourly; default 4). (regtest-only)", ArgsManager::ALLOW_ANY | ArgsManager::DEBUG_ONLY, OptionsCategory::DEBUG_TEST);
