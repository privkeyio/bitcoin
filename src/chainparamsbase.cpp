...
void SetupChainParamsBaseOptions(ArgsManager& argsman)
{
    ...
    argsman.AddArg("-coinbasematuritylong=<start>:<depth>", "Schedule the temporary extended generation maturity: from height <start> until the RDTS expiry, generation outputs must be <depth> blocks deep. Requires -rdtsexpiry. (regtest-only)", ArgsManager::ALLOW_ANY | ArgsManager::DEBUG_ONLY, OptionsCategory::DEBUG_TEST);
