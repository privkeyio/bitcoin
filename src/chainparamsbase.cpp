...
void SetupChainParamsBaseOptions(ArgsManager& argsman)
{
    ...
    // HARDFORK-PLUMBING: superseded by the PoW change branch's option.
    argsman.AddArg("-hardforktime=<n>", "Schedule the hardfork at the given UNIX timestamp, compared against each block's own timestamp for consensus and against the parent's median time past for policy. (regtest-only)", ArgsManager::ALLOW_ANY | ArgsManager::DEBUG_ONLY, OptionsCategory::DEBUG_TEST);
